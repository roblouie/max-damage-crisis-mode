...
export class EffectEngine {
  ...
  addEffect(spriteIndex: number, startPosition: Point, animationFrames: number[], animationRate: number, framesDuration: number, opacity: number, translationRate: Point, rotationRate: number, scaleRate: number) {
